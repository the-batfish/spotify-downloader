...
class GUI(tkinter.Tk):
    def __init__(self):
        ...
        self.cnvrt_button = tkinter.Button(
            self, text='ON', bd=0, bg='white', fg='black', font=("Arial", 12), command=self.convert)
        self.cnvrt_button.grid(row=11, column=2, sticky="SW")

        change_dir_button = tkinter.Button(self, text='Change download folder', bd=0, bg='white', fg='black', font=(
        ...
        self.download_but = tkinter.Button(self, text='Download songs', bd=0, bg='white', fg='black', font=(
